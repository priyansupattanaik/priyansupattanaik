...
|---|---|---|
| [ChronoMind](https://github.com/priyansupattanaik/ChronoMind) | Fine-tuned TinyLlama-1.1B · IEEE paper published | Next.js, FastAPI, LoRA, ChromaDB |
| [ResuScanner.AI](https://github.com/priyansupattanaik/ResuScanner.AI) | RAG-powered resume screener with Llama-3 | RAG, Llama-3, FastAPI, React |
| [Augur](https://github.com/priyansupattanaik/Augur) | Civil unrest early-warning system for India | NetworkX, FastAPI, React |
| [Vitamin Deficiency Detector](https://github.com/priyansupattanaik/VitaminDetect) | Multimodal diagnosis via InceptionV3 + Llama-3 | TensorFlow, Flask, Llama-3 |
